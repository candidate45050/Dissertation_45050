...
def create_sensitivity_analysis(matches_df: pd.DataFrame, costplus_df: pd.DataFrame) -> pd.DataFrame:
    ...
    for _, row in matches_df.iterrows():
        ...
        medicare_total_spending = row['total_spending_2025'] if 'total_spending_2025' in row and pd.notna(row['total_spending_2025']) else row['medicare_unit_price'] * row['total_dosage_units']
        total_units = row['total_dosage_units']
        medicare_generic_display = row['medicare_generic'] if pd.notna(row['medicare_generic']) else 'N/A'
...
def main():
    ...
    with st.spinner("Matching drugs between datasets..."):
        ...
        sensitivity_df = create_sensitivity_analysis(matches_df, costplus_df)
